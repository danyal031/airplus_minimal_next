      ...
      <>
        <div className="grid grid-cols-1 gap-4">
          ...
          <p className="text-text-main text-justify text-sm font-semibold leading-7">
            {config?.brand.fa} یکی از معتبرترین و بزرگ‌ترین پلتفرم‌های خرید بلیط
            ...
            توجهی از مشتریان خود جلب کند. با خدمات {config?.brand.fa}، شما
          ...
          <div className="grid grid-cols-12 gap-14">
            <div className="col-span-6 grid grid-cols-1 gap-2 text-text-main">
              ...
              <p className="text-justify text-sm font-semibold leading-7">
                {config?.brand.fa} به شما این امکان را می‌دهد که بلیط پروازهای
            ...
            <div className="col-span-6 grid grid-cols-1 gap-2 text-text-main">
              ...
              <p className="text-justify text-sm font-semibold leading-7">
                اگر قصد سفر به کشورهای دیگر را دارید، {config?.brand.fa} این
                ...
                {config?.brand.fa} به شما این اطمینان را می‌دهد که بلیط‌هایی با
    ...
    const benefits = [
      {
        ...
        title: "دسترسی آسان",
        icon: "",
        description: `${config?.brand.fa} به شما این امکان را می‌دهد که بلیط پروازهای داخلی خود را از ایرلاین‌های مختلف ایرانی نظیر ماهان، ایران ایر، کیش ایر، قشم ایر، و دیگر  ایرلاین‌های معتبر خریداری کنید. این ایرلاین‌ها با ویژگی‌ها و خدمات  مختلفی ارائه می‌دهند، از جمله قیمت‌های رقابتی و امکانات رفاهی متفاوت که  بسته به نیاز شما می‌توانید بهترین انتخاب را داشته باش.`,
      },
      {
        id: 2,
        title: "تقویم قیمتی",
...
const FlightDescriptionOnMobile = () => {
      ...
      <>
        <div className="grid grid-cols-1 gap-4">
          <div className="grid grid-cols-1 gap-2 text-text-main">
            ...
            <p className="text-text-main text-justify text-sm font-semibold leading-7">
              {config?.brand.fa} یکی از معتبرترین و بزرگ‌ترین پلتفرم‌های خرید
              ...
              {config?.brand.fa}، شما می‌توانید سفرهای داخلی و بین‌المللی خود را
          ...
          <div className="grid grid-cols-1 gap-2 text-text-main">
            ...
            <p className="text-justify text-sm font-semibold leading-7">
              اگر قصد سفر به کشورهای دیگر را دارید، {config?.brand.fa} این امکان
              ...
              معروف جهانی را رزرو کنید. برای سفرهای خارجی، {config?.brand.fa} به
  ...
  return (
    <>
      <div className="md:hidden grid grid-cols-1 gap-5 px-6">
        {renderAboutFlightTickets()}
        {renderPurchaseBenefits()}
      </div>
    </>
