...
import TitleDivider from "./article-list/TitleDivider";
    ...
    <div className="w-full grid grid-cols-12 gap-7">
      ...
      {posts.map((item) => {
        return (
          <div
            key={item}
            className="col-span-3 grid grid-cols-1 gap-4 p-2 border border-divider rounded-xl bg-default"
          >
            <div className="aspect-video min-h-28 relative rounded-xl overflow-hidden">
              ...
              <div className="absolute top-1 right-1 w-14 h-5 bg-primary-main rounded-md shadow-lg flex items-center justify-center">
                <span className="text-default text-[10px] font-semibold text-main">
                  شهر ها
                </span>
              </div>
            </div>
